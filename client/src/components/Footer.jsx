        ...
        <footer className="bg-[#FDF8EE] text-[#606060] w-full py-8">
            <div className="container px-8">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                    ...
                    {/* Company */}
                    <div>
                        <h3 className="text-[#00052E] font-semibold mb-4">Company</h3>
                    ...
                    {/* Support */}
                    <div>
                        <h3 className="text-[#00052E] font-semibold mb-4">Support</h3>
                        <ul className="space-y-2 text-sm">
                    ...
                    {/* Contact */}
                    <div>
                        <h3 className="text-[#00052E] font-semibold mb-4">Contact</h3>
                        <ul className="space-y-2 text-sm">
