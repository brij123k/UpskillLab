  ...
  const verifyPaymentOnServer = async () => {
    try {
      ...
      const response = await fetch(
        `/api/verify-payment?order_id=${paymentData.orderId}`
      );
              ...
              <div key={stepNum} className="flex flex-col items-center z-10">
                ...
                <span
                  className={`text-xs mt-2 ${
                    step >= stepNum ? "text-[#4D2C5E]" : "text-gray-500"
                  }`}
                >
            ...
            >
              <div className="bg-[#FFF5EF] p-4 rounded-lg">
                ...
                <div className="flex justify-between text-[#FF7426]">
                  <span>Discount:</span>
                  <span>
                    -₹{paymentData.originalPrice - paymentData.discountedPrice}
                  </span>
                </div>
              ...
              {!paymentStatus && (
                <>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="font-medium text-[#4D2C5E] mb-2">
                      Order Summary
                    </h4>
                  ...
                  <div className="border border-gray-200 rounded-lg p-4">
                    <h4 className="font-medium text-[#4D2C5E] mb-3">
                      Payment Method
                    </h4>
                    ...
                    <p className="text-xs text-gray-500 mt-2">
                      You'll be redirected to Cashfree's secure payment page to
                  ...
                  <label className="flex items-start mt-4">
                    ...
                    <span className="ml-2 text-sm">
                      I agree to the{" "}
                      <a href="/terms" className="text-[#4D2C5E] underline">
                  ...
                  <div className="bg-[#F8F9FA] p-3 rounded-lg flex items-start">
                    <svg
                      className="h-5 w-5 text-[#4D2C5E] mt-0.5 mr-2"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
