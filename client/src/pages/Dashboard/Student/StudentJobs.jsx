  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-6 lg:p-8">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-2xl md:text-3xl font-bold text-[#4D2C5E] mb-2">Job Opportunities</h1>
                ...
                <div className="p-4">
                  ...
                  <div className="flex justify-between items-center border-t border-gray-100 pt-4">
                    <button 
                      ...
                      className={`p-2 rounded-full ${job.saved ? 'text-[#FF7426]' : 'text-gray-400 hover:text-[#4D2C5E]'} transition`}
                    >
                      {/* <FiBookmark className={job.saved ? 'fill-current' : ''} size={18} /> */}
                    </button>
                    <div className="flex space-x-2">
                      {/* <button className="px-3 py-2 text-sm border border-[#4D2C5E] text-[#4D2C5E] rounded-lg hover:bg-[#4D2C5E]/10 transition">
                        Details
                      </button> */}
                      <button 
