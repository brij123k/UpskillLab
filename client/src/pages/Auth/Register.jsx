...
const RegistrationPage = () => {
    ...
    {submissionStatus && (
        <motion.div
            className={`fixed top-4 left-1/2 transform -translate-x-1/2 z-50 px-3 py-2 rounded-lg flex items-center w-[90vw] max-w-xs sm:max-w-md ${
        ...
        >
            {submissionStatus === 'success' ? (
                <>
                    <svg className="h-4 w-4 flex-shrink-0 mr-2" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span className="text-xs sm:text-sm">Verification code sent! Redirecting...</span>
                </>
            ) : (
                <>
                    <svg className="h-4 w-4 flex-shrink-0 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span className="text-xs sm:text-sm">Failed to send verification code. Please try again.</span>
                </>
            )}
        </motion.div>
    )}
